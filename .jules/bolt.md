...
## 2024-05-19 - Static Arrays in Components
**Learning:** Moving static arrays outside of React component functions prevents them from being re-allocated on every render, saving memory and garbage collection overhead.
**Action:** Always define static arrays and objects outside of component functions unless they depend on component state or props.
