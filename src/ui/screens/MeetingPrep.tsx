                            ...
                            <Modal
                                ...
                                footer={
                                    <div className="flex justify-end gap-2">
                                        <button className="btn-ghost focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-md" onClick={() => setIsNewMeetingOpen(false)}>Cancel</button>
            ...
            <div className="flex flex-col gap-6 relative" style={{ maxWidth: "1000px", margin: "0 auto" }}>
                <div className="flex justify-between items-center sticky top-0 bg-base py-4 z-10 glass px-4 rounded-lg">
                    <div className="flex items-center gap-4">
                        <button className="btn-ghost focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-md px-3 py-2" onClick={handleBack}>← Back</button>
                    ...
                    <div className="flex gap-2">
                        ...
                        <button className="btn-ghost text-error focus-visible:ring-2 focus-visible:ring-error focus-visible:outline-none rounded-md px-3 py-2" onClick={handleDelete}>Delete</button>
                    ...
                    <Modal isOpen={isEditOpen} onClose={() => setIsEditOpen(false)} title="Edit Details">
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex justify-end gap-2 mt-4">
                                <button className="btn-ghost focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-md px-3 py-2" onClick={() => setIsEditOpen(false)}>Cancel</button>
...
function CompleteMeetingForm({ meeting: _meeting, onCancel, onComplete }: { meeting: Meeting, onCancel: () => void, onComplete: (nextSteps: string, linkType: "NONE" | "OPPORTUNITY" | "RELATIONSHIP", linkId: string) => void }) {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-end gap-2 mt-4">
                <button className="btn-ghost focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-md px-3 py-2" onClick={onCancel}>Cancel</button>
                <button
