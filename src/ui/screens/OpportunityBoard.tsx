...
export function OpportunityBoard() {
    ...
    const load = () => {
        ...
        // Also groups independent promises to batch state updates and reduce React re-renders.
        Promise.all([
        ...
        }).catch(err => console.error("Failed to load opportunity board context", err));
    };
