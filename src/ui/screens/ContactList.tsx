    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex justify-between items-center">
                <h2>Relationships</h2>
                <button className="btn" disabled aria-label="Add new relationship (Coming soon)" title="Coming soon">Add New</button>
            </div>

            {contacts.length === 0 ? (
                <div className="flex flex-col items-center justify-center text-muted border-2 border-dashed border-base-300 rounded-xl py-12">
                    <div className="text-6xl mb-4" aria-hidden="true">👥</div>
                    <p className="text-lg font-medium">No relationships found.</p>
                    <p className="text-sm mt-1">Add a new relationship to start tracking.</p>
                </div>
            ) : (
