    ...
    return (
        ...
        >
            ...
            <div className="px-4 pb-4">
                <h3>
                    <button
                        className={`text-lg font-bold leading-tight text-left w-full cursor-pointer group-hover:text-primary transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:rounded px-1 -ml-1 after:absolute after:inset-0 after:z-0 after:content-[''] ${viewMode === 'HISTORY' ? 'line-through text-muted' : ''}`}
                        onClick={() => onEdit(mit)}
            ...
            {/* Footer / Links */}
            <div className="relative z-10 mt-auto p-3 bg-black/20 border-t border-[hsl(var(--color-border))] flex flex-wrap gap-2">
