                ...
                <div className="p-4 flex gap-2 justify-end border-b border-[hsl(var(--color-border))] bg-base-300/50">
                    {isAuthenticated && (
                        <button
                            onClick={fetchEvents}
                            disabled={loading}
                            className="btn btn-ghost btn-xs text-muted hover:text-primary transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                    ...
                    <button
                        ...
                        className={`btn btn-xs ${isAuthenticated ? 'btn-ghost text-success' : 'btn-ghost text-muted hover:text-primary'} focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none`}
