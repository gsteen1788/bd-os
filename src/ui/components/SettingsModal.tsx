...
// Optimization: Bolt ⚡ - Moved static themes array outside of component to prevent unnecessary memory allocation and garbage collection overhead on every render.
