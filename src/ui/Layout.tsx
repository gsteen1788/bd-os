...
// Optimization: Bolt ⚡ - Moved static configuration array (tabs) outside the component body.
// This prevents O(N) memory allocation and garbage collection overhead on every render cycle.
const tabs = [
