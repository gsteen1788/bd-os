...
// Optimization: Bolt ⚡ - Moved static tabs array outside of component to prevent unnecessary memory allocation and garbage collection overhead on every render.
const tabs = [
