...
// Optimization: Bolt ⚡ - Move static tabs array outside Layout component
// to prevent unnecessary memory allocation and garbage collection overhead on every render cycle.
const tabs = [
