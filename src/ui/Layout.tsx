...
// Optimization: Bolt ⚡ - Move static array outside render loop to prevent re-creation
const tabs = [
...
// Optimization: Bolt ⚡ - O(1) lookup Map for active tab label
