...
/**
 * Maximum allowed length for larger text content (e.g., descriptions, notes).
 */
 ...
 */
export const validateInput = (input: string, fieldName: string = "Input", maxLength: number = MAX_INPUT_LENGTH): void => {
    if (!input) return;
