...
export const validateSafeUri = (uri?: string | null): void => {
    ...
    // Normalize by removing all whitespaces and non-printable characters
    // to prevent bypasses like 'java\tscript:' or 'javascript :'
    const normalized = uri.replace(/[\s\x00-\x1F\x7F]+/g, "");
